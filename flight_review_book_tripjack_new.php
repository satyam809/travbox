...
//print_r($reviewSSRResult['conditions']['st']);
//print_r($reviewSSRResult['conditions']['sct']);
...
/*if($_SESSION['bookingIdReviewAPI'] == '') 
{
    header("Location:https://partners.momtap.in/flights");
}*/
...
//print_r($_SESSION['bookingIdReviewAPI']);
//die;
?>
      ...
      <div class="col-lg-8 col-sm-12 mobilemin" style="min-height:500px;">
        ...
        <div class="row">
          ...
          <div class="col-12" style="position:relative;display:none;" id="steptwopassengerdetails">
                  ...
                  <div class="row sliderpaxbox openpaxtabadult<?php echo $adult; ?>">
                    ...
                    <?php if (count($ssrInfoArr['BAGGAGE']) > 0) { ?>
                      ...
                      <div class="<?php if ($adults == '1') {
                        ...
                        <div class="js-form-message">
                          ...
                          <select name="abaggage<?php echo $adult; ?>" class="form-control adhendle adltbag" style="-moz-appearance: none;" tabindex="16" id="adltbag">
                    ...
                    <?php if (count($ssrInfoArr['MEAL']) > 0) { ?>
                      ...
                      <div class="<?php if ($adults == '1') {
                        ...
                        <div class="js-form-message">
                          ...
                          <select name="ameal<?php echo $adult; ?>" class="form-control adhendle adltmeal" style="-moz-appearance: none;" tabindex="" id="adltmeal">
				   ...
				   if (count($SeatDynamic) > 0) { ?>
                    ...
                    <?php } ?>
                      ...
                      <div class="col-sm-3 mb-4 seat_selection" style="display: none;">
                        ...
                        <div class="js-form-message">
                          ...
                          <a style="line-height: 1.0; max-width:200px;" class="btn btn-danger border-radius-3 d-flex align-items-center justify-content-center min-height-50 font-weight-bold border-width-2 py-2 w-100 seatview" data-id="" data-infcount="<?= $_SESSION['INF'] ?>" data-passenger="seatAdult_<?php echo $adult; ?>">View Seat</a>
                    ...
                    <?php if (count($ssrInfoArr['BAGGAGE']) > 0) { ?>
                      ...
                      <div class="<?php if ($adults == '1') {
                        ...
                        <div class="js-form-message">
                          ...
                          <select name="cbaggage<?php echo $child; ?>" class="form-control adhendle childbag" style="-moz-appearance: none;" tabindex="16" id="childbag">
                    ...
                    <?php if (count($ssrInfoArr['MEAL']) > 0) { ?>
                      ...
                      <div class="<?php if ($adults == '1') {
                        ...
                        <div class="js-form-message">
                          ...
                          <select name="cmeal<?php echo $child; ?>" class="form-control adhendle childmeal" style="-moz-appearance: none;" tabindex="" id="childmeal">
                      ...
                      <?php if (count($ssrInfoArr2['BAGGAGE']) > 0) { ?>
                        ...
                        <div class="<?php if ($adults == '1') {
                          ...
                          <div class="js-form-message">
                            ...
                            <select name="cbaggage2<?php echo $child; ?>" class="form-control adhendle childbag" style="-moz-appearance: none;" tabindex="16" id="childbag">
                      ...
                      <?php if (count($ssrInfoArr2['MEAL']) > 0) { ?>
                        ...
                        <div class="<?php if ($adults == '1') {
                          ...
                          <div class="js-form-message">
                            ...
                            <select name="cmeal2<?php echo $child; ?>" class="form-control adhendle childmeal" style="-moz-appearance: none;" tabindex="" id="childmeal">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4 mb-4">
                      ...
                      <div class="js-form-message">
                        ...
                        <input type="text" class="form-control" name="firstNameInf<?php echo $infant; ?>" id="firstNameInf<?php echo $infant; ?>" required data-msg="Please enter your first name." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="nope">
                    ...
                    <div class="col-sm-3 mb-4">
                      ...
                      <div class="js-form-message">
                        ...
                        <input type="text" class="form-control" name="lastNameInf<?php echo $infant; ?>" id="lastNameInf<?php echo $infant; ?>" required data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="nope">
                    ...
                    <?php if ($_SESSION['isdomestic'] == 'No') { ?>
                      ...
                      <div class="col-sm-4 mb-4">
                        ...
                        <div class="js-form-message">
                          ...
                          <select class="form-control js-select selectpicker dropdown-select" id="nationalityInf<?php echo $infant; ?>" name="nationalityInf<?php echo $infant; ?>" data-msg="Please select country." data-error-class="u-has-error" data-success-class="u-has-success" data-live-search="true" data-style="form-control font-size-16 border-width-2 border-gray font-weight-normal">
                      ...
                      <div class="col-sm-4 mb-4">
                        ...
                        <div class="js-form-message">
                          ...
                          <input type="text" class="form-control" name="passportNumberInf<?php echo $infant; ?>" id="passportNumberInf<?php echo $infant; ?>" placeholder="" aria-label="" data-msg="Please enter passport number" data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="nope" required>
                      ...
                      <div class="col-sm-4 mb-4">
                        ...
                        <div class="js-form-message">
                          ...
                          <input type="text" class="form-control datepickerfieldexpiry" name="passportExpiryInf<?php echo $infant; ?>" id="passportExpiryInf<?php echo $infant; ?>" placeholder="" aria-label="" data-msg="Please enter expiry Date" data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="nope" required>
            ...
            <div class="card cardresult cardresult_seatmap" data-tripinf2="<?= $_REQUEST['r'] != '' ?>" style="display: none; width:100%; margin-top:20px; height: 550px; overflow: auto">
             
              <div class="card-header seatmapchange">
              <?php
              if($_REQUEST['r'] != ''){
              ?>
              <a class="active trip1" onclick="triptype1()" style="padding: 10px 20px;">Seat Map</a>
              <a class="trip2" onclick="triptype2()" style="padding: 10px 20px;">Return Seat Map</a>
              <?php 
            }
            else{ 
              ?>
              ...
              <select class="select_passengers">
            <?php
            ...
            ?>
              ...
              <div class="card-body  seatmapload">
				
              </div>
              <div class="card-body seatmapload2" style="display: none;">
...
$('.seatview').on('click', function() {
    $(".seatmapload").load("flight_review_book_tripjack_seat_map.php?ResultIndex=<?= $ResultIndex ?>", function(responseTxt, statusTxt, xhr) {
        if (statusTxt == "success")
            if (statusTxt == "error")
                alert("Error: " + xhr.status + ": " + xhr.statusText);
    });
	let triptype = $('.cardresult_seatmap').attr('data-tripinf2');
	if(triptype != ''){
	 $(".seatmapload2").load("flight_review_book_tripjack_roundtrip_seat_map.php?ResultIndex=<?= $ResultIndex ?>&ResultIndex2=<?= $ResultIndex2 ?>", function(responseTxt, statusTxt, xhr) {
        if (statusTxt == "success")
            if (statusTxt == "error")
                alert("Error: " + xhr.status + ": " + xhr.statusText);
    });
	}
    $('.cardresult_seatmap').show();

    $('.cardresult_detail').hide();
})
</script>
            ...
            <div class="card cardresult" style="width:100%; margin-top:20px;">
              ...
              <div class="card-footer text-muted" id="showfooterpay" style="display:none;">
                ...
                <button type="button" class="btn btn-danger btn-sm pay_btn" style="float:right;" onClick="$('#steponeflightdetails').hide();$('#steptwopassengerdetails').hide();$('#stepfourpayments').show();$('.flightreviewbox').removeClass('active');$('#strp4').addClass('active');$('.hidefooter').show();$('#showfooterpay').hide();">Proceed To Pay</button>
              ...
              <div class="row">
                ...
                <div class="col-4">
                  ...
                  <div style="padding: 40px 0px; text-align: center;  font-size: 30px; border-bottom-left-radius: 5px; <?php if ($totalwalletBalance >= $basefare[1]) { ?>border-right: 2px solid #41e0d2; background-color: #e4f8ff; color:#02C4B0;<?php } else { ?>border-right: 2px solid #e04159; background-color: #ffe4e4;color:#c4021e;<?php } ?>">
                    ...
                    <div style="font-weight:600;" class="totalwalletBal" data-pay="<?php echo round($totalwalletBalance); ?>">₹<?php echo round($totalwalletBalance); ?></div>
                  ...
                  <div class="card-body">
                    ...
                    <div style=" font-size:14px; margin-bottom:10px; margin-top:15px;">
                      ...
                      <?php if ($totalwalletBalance >= ($finaltotalpay)) { ?>
                        ...
                        <button type="button" class="btn btn-danger pay_now_btn" onClick="payandbooknow();" id="paywalletbtn">Pay Now ₹<?php echo ($finaltotalpay); ?></button>
...
<?php } */ ?>
      ...
      <div class="col-lg-4 col-sm-12 faresummrybox">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:14px; color:#000000;">
              <tr>
                ...
                <td width="50%" align="right" style="padding:10px 0px; border-bottom:1px solid #ddd; font-size:14px;"><strong>₹<?php
                                                                                                                        ...
                                                                                                                        $basefare = explode("=", $str_arr[0]);
                                                                                                                        echo $BaseFare = ($basefare[1] + $basefareret); ?><strong></td>
              </tr>
              <?php
              ...
              <tr class="hidecommall">
                ...
                <td align="right" style="padding:10px 0px; border-bottom:1px solid #ddd; font-size:14px;">₹<?php  
                                                      ...
                                                      echo $totalbasefarechd * $_SESSION['CHD'];                                                      ?></td>
              </tr>
              <?php
              }
              ...
              <tr class="hidecommall">
                ...
                <td align="right" style="padding:10px 0px; border-bottom:1px solid #ddd; font-size:14px;">₹<?php  $totalbasefareinf = $basefareinf +$basefareinf2;
              ...
              <tr class="hidecomm">
                ...
                <td align="right" style="padding:10px 0px; border-bottom:1px solid #ddd; font-size:14px;">₹<?php  $totalcommission =abs($totalcommission); 
  ...
  function checkInputs() {
    ...
    if (e != 1) {
      ...
      $('.form-control').removeClass('redborderfiled');
	   ...
	   let inf_count =$('.seatview').attr('data-infcount');
	if(inf_count != 0){
	$('.seat_selection').hide();
	}else{
	$('.seat_selection').show();
...
<script type="text/javascript">
...

  {
    ...
    var totalPricePay = (baseFarePrice + TaxAndFee + BaggageFeeInn + BaggageFeeInnC + MealFeeInn + MealFeeInnC + BaggageFeeInn2 + MealFeeInn2 + SeatPriceInn + agentmarkup + SeatPriceInn2 + agentmarkup2 + totaltdsdisplay + totalcommissiongstdisplay) - earnedcommission;
...
let totalwalletBal=$('.totalwalletBal').attr('data-pay');
  let totalAmountforPay=$('#totalAmountToPay').val();
  if(totalwalletBal >= totalAmountforPay){
	$('.pay_now_btn').show();  
  }else{
	  $('.pay_now_btn').hide();
  }
