...
<body class="greybluebg">
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%" align="left" valign="top" id="fromflightdestination">
                                            ...
                                            <label>
                                                ...
                                                <input type="text" class="textfield" requered="" onKeyUp="getSearchHotel(event)" name="searchDestination" autocomplete="nope" value="Delhi,India">
    ...
    <!-- <iframe style="display:none;" src="<?php //echo $pagesearch; 
                                            ?>"></iframe> -->
