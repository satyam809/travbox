...
$req=file_put_contents("FLYTBOJSON/FlyShopFarequoteIBReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopFarequoteIBReq.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/FlyShopFarequoteIBRes.txt","$flightRes");
$fare_quote_resultR = json_decode($flightRes,true);
}
catch(Exception $e)
{
   //echo $e;
