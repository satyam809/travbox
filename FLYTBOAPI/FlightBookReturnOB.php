...
$req=file_put_contents("FLYTBOJSON/FlyShopBookRoundOBReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopBookRoundOBReq.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/FlyShopBookRoundOBRes.txt","$flightRes");
