...
$req=file_put_contents("FLYTBOJSON/FlyShopTicketLCCReq3.txt","$req");

$postdata = file_get_contents("FLYTBOJSON/FlyShopTicketLCCReq3.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/FlyShopTicketLCCRes3.txt","$flightRes");
