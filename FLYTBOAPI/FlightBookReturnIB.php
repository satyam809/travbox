...
$req=file_put_contents("FLYTBOJSON/FlyShopBookRoundIBReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopBookRoundIBReq.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/FlyShopBookRoundIBRes.txt","$flightRes");
...
//echo '<pre>';print nl2br(print_r($book_resultR, true));echo '</pre>'; 
?>