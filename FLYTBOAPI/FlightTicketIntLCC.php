...
$req=file_put_contents("FLYTBOJSON/FlyShopTicketLCCReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopTicketLCCReq.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/FlyShopTicketLCCRes.txt","$flightRes");
