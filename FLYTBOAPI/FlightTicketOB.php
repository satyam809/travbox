...
$req=file_put_contents("FLYTBOJSON/FlyShopTicketOBReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopTicketOBReq.txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$results=file_put_contents("FLYTBOJSON/FlyShopTicketOBRes.txt","$flightRes");
