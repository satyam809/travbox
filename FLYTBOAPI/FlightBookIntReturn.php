...
$req=file_put_contents("FLYTBOJSON/FlyShopBookIntRoundReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopBookIntRoundReq.txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$results=file_put_contents("FLYTBOJSON/FlyShopBookIntRoundRes.txt","$flightRes");
