...
$req=file_put_contents("FLYTBOJSON/FlyShopTicketIBReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopTicketIBReq.txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$results=file_put_contents("FLYTBOJSON/FlyShopTicketIBRes.txt","$flightRes");
$ticket_resultR = json_decode($flightRes,true);
}
catch(Exception $e)
{
   //echo $e;
...
//echo '<pre>';print nl2br(print_r($ticket_result, true));echo '</pre>'; 
?>