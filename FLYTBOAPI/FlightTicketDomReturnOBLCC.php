...
$req=file_put_contents("FLYTBOJSON/FlyShopTicketDomReturnOBLCCreq.txt","$req");

$postdata = file_get_contents("FLYTBOJSON/FlyShopTicketDomReturnOBLCCreq.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/FlyShopTicketDomReturnOBLCCres.txt","$flightRes");
...
//echo '<pre>';print nl2br(print_r($book_result, true));echo '</pre>'; 
?>