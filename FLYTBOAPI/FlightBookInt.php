...
$infant = $data['infant'];
 ...
 $FareBreakdown = $selectedflight['FareBreakdown']; 
   foreach($FareBreakdown as $fbse)
{
	...
	if($PassengerType == '1')
	{
	   ...
	   $BaseFareadlt = $fbse['BaseFare']; 
	   $Taxadlt = $fbse['Tax']; 
	   $YQTaxadlt = $fbse['YQTax']; 
	...
	if($PassengerType == '2')
	{
	   ...
	   $BaseFarechld = $fbse['BaseFare']; 
	   $Taxchld = $fbse['Tax']; 
	   $YQTaxchld = $fbse['YQTax']; 
	...
	if($PassengerType == '3')
	{
	   ...
	   $BaseFareinfnt = $fbse['BaseFare']; 
	   $Taxinfnt = $fbse['Tax']; 
	   $YQTaxinfnt = $fbse['YQTax']; 
...
$req=file_put_contents("FLYTBOJSON/FlyShopBookIntReq.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/FlyShopBookIntReq.txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$results=file_put_contents("FLYTBOJSON/FlyShopBookIntRes.txt","$flightRes");
