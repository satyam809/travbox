...
if($_REQUEST['id']!=''){
$rs5=GetPageRecord('*','sys_contentPages',' id="'.decode($_REQUEST['id']).'" '); 
		...
		<form action="frmaction.html" method="post" enctype="multipart/form-data" name="addeditfrm" target="actoinfrm" id="addeditfrm"> 
			<div class="card">
				<div class="card-header bg-light header-elements-inline">
					<h5 class="card-title"><?php if($_REQUEST['id']!=''){ echo 'Edit'; } else { echo 'Add'; } ?> Content Page</h5>
				</div>
...
CKFinder.setupCKEditor( editor,'ckeditor/ckfinder/' ) ;
				...
				<div class="card-footer text-right">
					...
					<input name="action" type="hidden" id="action" value="addcontentpages" />
