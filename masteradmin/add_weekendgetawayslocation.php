...
if($_REQUEST['id']!=''){
$rs5=GetPageRecord('*','weekendGatewayLocationMaster',' parentId="'.$LoginUserDetails['parentId'].'" and id="'.decode($_REQUEST['id']).'" '); 
		...
		<div class="content-wrapper">
			...
			<div class="col-md-6">
					<div class="row">
						...
						<div class="form-group">
						   ...
						   <div class="form-group">
									...
									<input name="companyLogo" type="file" class="form-control" id="companyLogo">
									
									<input name="oldimg" type="hidden" class="form-control" id="oldimg" value="<?php echo $editresult['img']; ?>">
						   </div>
						   ...
						   <div class="form-group">
									...
									<div class="custom-control custom-checkbox custom-control-inline">
										...
										<label class="custom-control-label" for="status">Active this Weekend Gateway Location</label>
										.
									</div>
				  ...
				  <div class="card-footer text-right">
							    ...
							    <input name="action" type="hidden" id="action" value="weekendgetawayslocation" />
