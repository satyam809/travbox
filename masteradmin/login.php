...
<html lang="zxx">
 ...
 <head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="<?php echo $fullurl; ?>upload/<?php echo $getlogo['companyLogo']; ?>" type="image/x-icon" >
    ...
    <div class="container">
        <div class="row login-box" style="max-width:350px; background-color:transparent;">
            <div class="col-lg-12 align-self-center pad-0">
				...
				<div style="text-align:center; margin-bottom:10px;"><img src="<?php echo $fullurl; ?>upload/<?php echo $getlogo['companyLogo']; ?>" alt="<?php echo stripslashes($getlogo['companyName']); ?>" style="height:70px;"></div>
