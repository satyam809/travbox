...
if($_REQUEST['id']!=''){
$rs5=GetPageRecord('*','sys_queryClosureReasons',' parentId="'.$LoginUserDetails['parentId'].'" and id="'.decode($_REQUEST['id']).'" '); 
		...
		<div class="content-wrapper">
			...
			<div class="col-md-6">
				  ...
				  <div class="card-footer text-right">
							    ...
							    <input name="action" type="hidden" id="action" value="savequeryclosurereasons" />
