...
<div class="card-footer d-flex justify-content-between">
							<span class="text-muted" style="font-weight:500; color:#000000 !important;"><a href="display.html?ga=query&view=1&id=<?php echo encode($rest['id']); ?>">Quotation (#QT<?php echo encode($quotationDetail['id']); ?>)</a>  &nbsp;&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;  Hotel Quotation</span>			</div>
...
<span class="text-muted" style="font-weight:500; color:#000000 !important;"><i class="fa fa-bed" aria-hidden="true"></i> &nbsp;Hotel</span>
		...
		<div style="padding:20px;" id="loadoptionhotel"></div>
	
	<script>
	function loadloadoptionhotel(){
	$('#loadoptionhotel').load('loadoptionhotelopen.php?id=&qid=<?php echo encode($quotationDetail['id']); ?>&qt=other'); 
	}
	
	function loadloadoptionhoteldelete(id){
	$('#loadoptionhotel').load('loadoptionhotelopen.php?id=&qid=<?php echo encode($quotationDetail['id']); ?>&qt=other&did='+id); 
	}
