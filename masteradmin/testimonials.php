			...
			<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
							<div class="list-icons">
		                		 <a href="display.html?ga=<?php echo $_REQUEST['ga']; ?>&add=1"><button type="button" class="btn btn-primary btn-sm">Add Testimonials</button></a>
		                	</div>
	                	</div>
			  </div>		 
...
$rs=GetRecordList('*','sys_testimonials',' where    addBy="'.$_SESSION['userid'].'"  order by id desc  ','100',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
...
<tr>
	<td align="left" valign="top"><div style="max-width:200px;"><?php echo stripslashes($rest['description']); ?></div></td>
	
	<td align="left" valign="top"><?php echo stripslashes($rest['name']); ?></td>
	<td align="left" valign="top"><?php echo stripslashes($rest['starRating']); ?> Star</td>
