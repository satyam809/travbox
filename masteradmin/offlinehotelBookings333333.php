 <div class="page-header">
		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><a href="<?php echo $fullurl; ?>"><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Dashboard</span></a> - Offline Hotel Booking</h4> 
			</div>
...
<strong>Child: </strong><?php echo mysqli_num_rows($rs7); ?> </div></td>
									...
									<td align="left" valign="top"><?php if($rest['pickedBy']>0){ 
