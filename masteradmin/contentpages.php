...
?>		
		<div class="content-wrapper">
			...
			<div class="card-header header-elements-inline">
						<h5 class="card-title">Content Pages</h5>
						<div class="header-elements">
							<div class="list-icons">
		                		 <a href="display.html?ga=<?php echo $_REQUEST['ga']; ?>&add=1"><button type="button" class="btn btn-primary btn-sm">Add Page</button></a>
		                	</div>
	                	</div>
			  </div>		 
...
$rs=GetRecordList('*','sys_contentPages',' where   addBy="'.$_SESSION['userid'].'"   order by id asc  ','100',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
