...
<table width="100%" border="0" cellspacing="0" cellpadding="5" style=" ">
  <tr>
    <td width="50%" align="left" valign="top" style="border-bottom:1px solid #ddd;"><img src="<?php echo $imgurl; ?><?php echo $agentData['companyLogo']; ?>" height="66"></td>
...
13. Additional GST Payment (if any) to be paid to the hotel directly by the guest.<br /></td>
  ...
  <tr>
    ...
    <td align="right" style="border-bottom:1px solid #ddd;">&#8377;<?php echo round($editresult['agentTotalFare']); ?></td>
  </tr>
  <?php } ?>
  <tr>
    <td>&nbsp;</td>
