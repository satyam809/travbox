...
$namevalue ='name="'.$name.'",email="'.$email.'",phone="'.$phone.'",address="'.$address.'",branchId="'.$branchId.'",roleId="'.$roleId.'",status="'.$status.'",staffCreditLimit="'.$staffCreditLimit.'",password="'.md5($randPass).'",addDate="'.date('Y-m-d H:i:s').'",addBy="'.$_SESSION['userid'].'",parentId="'.$LoginUserDetails['parentId'].'",userType="admin_user" '.$sql.'';  
...
$namevalue ='cityName="'.$cityName.'",name="'.$name.'",category="'.$category.'",hotelAmenities="'.$hotelAmenities.'",lat="'.$lat.'",lon="'.$lon.'",address="'.$address.'",cancellationType="'.$cancellationType.'",hotelPhoto="'.$eventphoto.'",hotelPhoto2="'.$eventphoto2.'",hotelPhoto3="'.$eventphoto3.'",hotelPhoto4="'.$eventphoto4.'",hotelPhoto5="'.$eventphoto5.'",checkInTime="'.$checkInTime.'",checkOutTime="'.$checkOutTime.'",hotelDetails="'.$eventDetails.'",hotelType="'.$hotelType.'",parentId="'.$LoginUserDetails['parentId'].'",status="'.$status.'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
addlistinggetlastid('hotelMaster',$namevalue); 
...
$namevalue ='name="'.$name.'",status="'.$status.'",agentTypeGroupId="'.decode($typeid).'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
...
$namevalue ='blockFlightId="'.$blockFlightId.'",name="'.$name.'",agentTypeGroupId="'.decode($typeid).'",editBy="'.$_SESSION['userid'].'",editDate="'.date('Y-m-d H:i:s').'"';   
...
$namevalue ='blockFlightId="'.$blockFlightId.'",name="'.$name.'",agentTypeGroupId="'.decode($typeid).'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
...
$namevalue ='name="'.$name.'",agentTypeGroupId="'.decode($typeid).'",status="'.$status.'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
...
$namevalue ='flightId="'.$flightId.'",name="'.$name.'",agentTypeGroupId="'.decode($typeid).'",markupType="'.$markupType.'",markupValue="'.$markupValue.'",editBy="'.$_SESSION['userid'].'",editDate="'.date('Y-m-d H:i:s').'"';   
...
$namevalue ='flightId="'.$flightId.'",name="'.$name.'",agentTypeGroupId="'.decode($typeid).'",markupType="'.$markupType.'",markupValue="'.$markupValue.'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
...
$namevalue ='agentId="'.$agentcate['id'].'",agentTypeGroupId="'.decode($typeid).'",flightId="'.$flightId.'",name="'.$name.'",markupType="'.$markupType.'",markupValue="'.$markupValue.'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
addlistinggetlastid('agent_fareTypedomesticFlightsMarkupMaster',$namevalue);  
...
$namevalue ='flightId="'.$flightId.'",name="'.$name.'",commissionType="'.$commissionType.'",markupType="'.$markupType.'",markupValue="'.$markupValue.'",cashBackType="'.$cashBackType.'",cashBackValue="'.$cashBackValue.'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
...
$namevalue ='agentId="'.$agentcate['id'].'",flightId="'.$flightId.'",commissionType="'.$commissionType.'",name="'.$name.'",markupType="'.$markupType.'",markupValue="'.$markupValue.'",cashBackType="'.$cashBackType.'",cashBackValue="'.$cashBackValue.'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
//addlistinggetlastid('agent_fareTypedomesticFlightsCommissionMaster',$namevalue); 
...
$namevalue ='flightId="'.$flightId.'",name="'.$name.'",agentTypeGroupId="'.decode($typeid).'",editBy="'.$_SESSION['userid'].'",editDate="'.date('Y-m-d H:i:s').'"';   
...
$namevalue ='flightId="'.$flightId.'",name="'.$name.'",agentTypeGroupId="'.decode($typeid).'",parentId="'.$LoginUserDetails['parentId'].'",addBy="'.$_SESSION['userid'].'",addDate="'.date('Y-m-d H:i:s').'"';  
...
$sql_insk="insert into sys_userLogs set  currentIp='".$_SERVER['REMOTE_ADDR']."',logType='updatewebsitesetting',details='Website Setting Updated',userId='".$_SESSION['userid']."',parentId='".$LoginUserDetails['parentId']."',addDate='".time()."'"; 
mysqli_query(db(),$sql_insk) or die(mysqli_error(db())); 
