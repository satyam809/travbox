 <div class="page-header">
		...
		<div class="page-header-content header-elements-md-inline" >
			<div class="page-title d-flex">
				<h4><a href="<?php echo $fullurl; ?>"><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Dashboard</span></a> - Hotel Enquiry</h4> 
			</div>
...
<div class="page-content pt-0" > 
		...
		<div class="content-wrapper">
			...
			<div class="card-header header-elements-inline">
						<h5 class="card-title">Hotel Enquiry List</h5>
...
$rs=GetRecordList('*','hotelEnquiry',' where 1 and agentId in (select id from sys_userMaster where parentId="'.$_SESSION['userid'].'") '.$search.' order by id desc','25',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
...
<strong>Destination: </strong><?php echo strip($rest['city']); ?>												  </td>
