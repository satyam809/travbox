...
<table width="100%" border="1" cellpadding="20" cellspacing="0" bordercolor="#CCCCCC">
  <tr>
    <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" style="font-size:20px; font-weight:500;">Booking <?php if($editresult['status']==1){ ?>
          Pending
          <?php } ?>
        ...
        <td width="50%" align="right"><strong style="font-size:18px;"><?php echo stripslashes($agentData['companyName']); ?></strong><br>
...
<strong> </strong> <?php echo stripslashes($agentData['email']); ?><br />
  ...
  <tr>
    <td colspan="3"><table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#000000">
      <tr>
        <td colspan="2" align="left" valign="top">Booking Id: <strong><?php echo encode($editresult['id']); ?></strong>  <br />
...
<?php echo $editresult['flightNo']; ?> </td>
	...
	<table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#CCCCCC">
      ...
      <tr>
        ...
        <td colspan="2">Rs.<?php echo number_format($editresult['tax']+$editresult['agentMarkup']-($editresult['agentTax']-$editresult['clientTax'])); ?></td>
      </tr>
