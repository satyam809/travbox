...
if(trim($string)!='' && trim($string)!='0'){
$encoded=$string+4409; 
return substr($encoded, -4); 
}
}


function decodemakeAgentId($string){
if(trim($string)!='' && trim($string)!='0'){
$encoded=$string-4409; 
return substr($encoded, -4); 
}
...
$subject = 'Booking Confirmation - '.$tid.'';
...
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
 ...
 $headers .= "From: ".$invoiceData['emailAccount']." \r\n"; 
 mail($LoginParentId['email'],$subject,$mailbody,$headers);
}
?>