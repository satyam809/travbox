...
$rs=GetRecordList('*','sys_balanceSheet',' where 1 '.$search.' and  agentId in (select id from sys_userMaster where id="'.$_SESSION['userid'].'")  order by id desc  ','25',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
...
<tr>
	...
	<a href="display.html?ga=agents&id=<?php echo encode($agentData['id']); ?>&view=1" target="_blank"><strong><?php echo strip($agentData['companyName']); ?></strong></a>
