...
if($_REQUEST['dltid']!=''){ 
deleteRecord('fareTypeofflineflightsbookingMaster','id="'.decode($_REQUEST['dltid']).'" and parentId="'.$_SESSION['userid'].'"'); 
deleteRecord('agent_fareTypeofflineflightsbookingMaster',' blockFlightId="'.$id.'" and parentId="'.$_SESSION['userid'].'"');
}
?>
...
$n=1;  
$roomslist='';
$rs=GetPageRecord('*','fareTypeofflineflightsbookingMaster',' flightId="'.$id.'" and parentId="'.$_SESSION['userid'].'" order by id desc');
...
<?php
$roomslist='';
$a=GetPageRecord('*','fareTypeofflineflightsbookingMaster',' flightId="'.$id.'" and parentId="'.$_SESSION['userid'].'" order by id desc');
