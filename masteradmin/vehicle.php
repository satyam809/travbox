...
<span onclick="loadpop('Add Vehicle',this,'600px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=addvehiclelibrary" class="badge bg-blue dropdown-toggle caret-0" style="background-color: #0cb5b5; position: absolute; right: 15px; top: 13px; font-size: 12px; cursor: pointer;" >Add Vehicle</span> 

<span class="text-muted" style="font-weight:500; color:#000000 !important;"><i class="fa fa-car" aria-hidden="true"></i> Vehicle</span>
</div>
...
<table class="table">
							<thead>
								<tr>
									...
									<th width="20%"><div align="center">Pax</div></th>
...
$rs=GetRecordList('*','sys_vehicleMaster',' where parentId="'.$LoginUserDetails['parentId'].'" '.$search.' order by id desc  ','100',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
...
?>
								<tr>
									...
									<td width="20%"><div align="center"><?php echo stripslashes($rest['pax']); ?></div></td>
									...
									<td width="10%"><div align="center"><a  style="cursor:pointer;" onclick="loadpop('Edit Vehicle',this,'600px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=addvehiclelibrary&id=<?php echo encode($rest['id']); ?>">
