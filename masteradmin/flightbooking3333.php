...
<div class="page-content pt-0" > 
		...
		<div class="content-wrapper">
			...
			<div class="card-header header-elements-inline">
						<h5 class="card-title">Online Flight Booking List</h5>
...
$rs=GetRecordList('*','flightBookingMaster',' where 1 and agentBookingType=0 and bookingType=0  '.$search.'  order by id desc  ','25',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
...
$userinfo=mysqli_fetch_array($se); echo $userinfo['name'];  }else{ ?><input type="checkbox" id="pickedBy<?php echo encode($rest['id']); ?>" onclick="pickedbyfun('<?php echo encode($rest['id']); ?>');" /><?php } ?></td>
									<td align="left" valign="top"><?php if($rest['status']==0){ ?><span class="badge bg-blue" style="background-color:#d97979;">Booking Under Process</span><?php } ?>
