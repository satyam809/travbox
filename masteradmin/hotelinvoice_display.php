...
if($_REQUEST['id']!=''){
$a=GetPageRecord('*','hotelBookingMaster',' id="'.decode($_REQUEST['id']).'" and agentId in (select id from sys_userMaster where parentId="'.$_SESSION['userid'].'")'); 
 ...
 <tr>
  ...
  <tr>
    ...
    <tr>
        ...
        <td align="center">:</td>
        <td align="right"><?php echo number_format($rest['agentOtherCharges']-$rest['agentMarukup']); ?>  INR</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="right"><strong><?php echo number_format(($rest['baseFare']+$rest['agentOtherCharges']+$tds)-($comm+$rest['agentMarukup'])); ?> INR</strong></td>
      </tr>
    </table></td>
  </tr> 
  <tr>
