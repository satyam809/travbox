						...
						<table class="table">
							<thead>
								<tr>
								  ...
								  <th>ID</th>
								  <th>Flight</th>
									<th><div style="width:80px;">Route</div></th>
...
?>
								...
								<tr>
								    	<td align="left" valign="top"><?php echo $rest['id']; ?></td>
								  <td align="left" valign="top"><?php echo date('d-m-Y h:i A', strtotime($rest['bookingDate'])); ?><div style="margin-top:4px; font-size:12px; font-weight:500; width:130px;"><?php echo $rest['clientType']; ?></div><?php if($cont>1){ ?> 
...
<span class="badge bg-blue" >Fixed Departure</span><?php } ?><?php if($rest['pnrNo']!=''){?><div style="border:1px dashed #ddd; padding:2px 4px; background-color:#E6FFF5; float:left; border:1px solid #88FFED; font-weight:500;"><i class="fa fa-tag" aria-hidden="true"></i> <?php echo stripslashes($rest['pnrNo']); ?></div><?php } ?></td>
								  <td align="left" valign="top"><strong><?php echo stripslashes($rest['flightName']); ?>&nbsp;(<?php echo stripslashes($rest['flightNo']); ?>)</strong><div style="font-size:11px; color:#666666;"><?php echo stripslashes($rest['pcc']); ?></div></td>
									<td align="left" valign="top"><strong>From: </strong><?php $arr = explode('-',$rest['source']); echo $arr[1]; ?>
									<strong>To:</strong>
									<?php $arr2 = explode('-',$rest['destination']); echo $arr2[1]; ?></td>
									...
									<td align="left" valign="top"><?php echo stripslashes($rest['agentTotalFare']-$rest['markup']); ?>
									<div style="margin-top:3px; width:100px;"><strong>Ins.: </strong><?php echo stripslashes($rest['insuranceAmount']); ?></div>
									<div style="margin-top:3px;"><strong>Dn.: </strong><?php echo stripslashes($rest['donateAmount']); ?></div>									</td>
