...
$rs=GetRecordList('*','sys_queryWidget',' where parentId="'.$LoginUserDetails['parentId'].'" order by id asc  ','100',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
...
?>
								...
								<tr>
									<td align="left" valign="top"><a href="display.html?ga=<?php echo $_REQUEST['ga']; ?>&add=1&id=<?php echo encode($rest['id']); ?>"><strong><?php echo stripslashes($rest['formTitle']); ?></strong></a></td>
									<td align="left" valign="top"><?php echo stripslashes($rest['websiteName']); ?></td>
									<td align="left" valign="top"><?php echo getsectionstatus($rest['status']); ?></td>
									<td align="left" valign="top"><button type="button" class="btn btn-secondary btn-sm" onclick="loadpop('Widget Code',this,'600px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=copywidgetcode&id=<?php echo encode($rest['id']); ?>" ><i class="fa fa-code" aria-hidden="true"></i> &nbsp;Copy</button></td>
