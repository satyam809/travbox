...
<span class="text-muted" style="font-weight:500; color:#000000 !important;"><i class="fa fa-plane" aria-hidden="true"></i> International Flights Commission</span>
</div>
...
<table class="table">
							...
							<tbody>
							<?php
							$rs=GetPageRecord('*','internationalFlightsCommissionMaster',' id=1 order by id desc');
							...
							<tr>
							 ...
							 <input name="action" type="hidden" id="action" value="addinternationalFlightsCommission">   
