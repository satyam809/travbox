...
$rs5=GetPageRecord('*','sys_userMaster',' id="'.($_SESSION['userid']).'"'); 
...
<?php } ?>
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input name="oldcompanyLogo2" type="hidden" value="<?php echo $editresult['companyLogo']; ?>" />
				 ...
				 <input name="companyLogo2" type="file" class="form-control" />
									 
					      </div>
						</div>
						
			<div style="padding:5px 10px; background-color:#F5F5F5; margin-bottom:10px; width:100%;"><strong>Login Banner</strong></div>			
					 	
					<?php if($editresult['loginBanner']!=''){ ?>
						<div class="col-md-3">
						<div class="form-group">
				<div style="width: 100%; background-color: #fff; border:1px solid #293a50; padding:0px; border-radius: 4px; text-align: center;"><img src="<?php echo $fullurl; ?>upload/<?php echo $editresult['loginBanner']; ?>" alt="<?php echo stripslashes($editresult['companyName']); ?>" style="max-width:100%; height:50px;"></div>
				
				<input name="oldcompanyLogo" type="hidden" value="<?php echo $editresult['loginBanner']; ?>" />
...
<div class="col-md-3" style="display:none;">
				   ...
				   <div class="card-footer text-right">
							    ...
							    <input name="action" type="hidden" id="action" value="savemyprofile" />
							    <input name="editid" type="hidden" id="editid" value="<?php echo decode($_SESSION['userid']); ?>" />
				  </div>
