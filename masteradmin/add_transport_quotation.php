...
<div class="card-footer d-flex justify-content-between">
							<span class="text-muted" style="font-weight:500; color:#000000 !important;"><a href="display.html?ga=query&view=1&id=<?php echo encode($rest['id']); ?>">Quotation (#QT<?php echo encode($quotationDetail['id']); ?>)</a>  &nbsp;&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;  Transport Quotation</span>			</div>
...
<span class="text-muted" style="font-weight:500; color:#000000 !important;"><i class="fa fa-car" aria-hidden="true"></i> &nbsp;Transport</span>
	...
	$('#loadquotationtransport').load('loadquotationtransport.php?qid=<?php echo encode($quotationDetail['id']); ?>&qt=other'); 
	}	
	
	function deleteloadquotationtransport(id){
	$('#loadquotationtransport').load('loadquotationtransport.php?qid=<?php echo encode($quotationDetail['id']); ?>&qt=other&tdid='+id); 
	}		
