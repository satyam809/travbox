 <div class="page-header">
		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><a href="<?php echo $fullurl; ?>"><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Dashboard</span></a> - Online Hotel Booking</h4> 
			</div>
...
$rs=GetRecordList('*','hotelBookingMaster',' where 1 and agentId in (select id from sys_userMaster where parentId="'.$_SESSION['userid'].'") and BookingNumber!="" and agentBookingType=0 and bookingType=0 and status!=0 '.$search.' order by id desc  ','25',$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2];  
...
<strong>Child: </strong><?php echo  stripslashes($totalbookungpax_child['totalchild']); ?> </div></td>
									<td align="left" valign="top">&#8377;<?php echo round($rest['agentTotalFare']-$rest['agentMarukup']); ?></td>
									<td align="left" valign="top">&#8377;<?php echo round($rest['agentTotalFare']); ?></td>
									<td align="left" valign="top">&#8377;<?php echo round($rest['agentMarukup']); ?></td>
