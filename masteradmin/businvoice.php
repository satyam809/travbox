...
if($_REQUEST['id']!=''){
$a=GetPageRecord('*','busbookingMaster',' id="'.decode($_REQUEST['id']).'" and agentUserid="'.$_SESSION['agentUserid'].'"'); 
...
$urs=GetPageRecord('*','sys_userMaster',' id="'.$rest['agentUserid'].'" '); 
  ...
  <tr>
    ...
    <td width="33%" align="right"><table width="100%" border="0" cellpadding="0">
      <tr>
        ...
        <td width="44%" align="right"><?php echo number_format($rest['totalFare']-$rest['agentMarukup']); ?> INR</td>
      </tr>
      
      <tr>
        <td align="right">Service Charges </td>
        <td align="center">:</td>
        <td align="right"><?php echo number_format($rest['agentMarukup']); ?> INR</td>
      </tr>
      <tr>
        <td align="right"><strong>Grand Total</strong></td>
        <td align="center"><strong>:</strong></td>
        <td align="right"><strong><?php echo number_format($rest['totalFare']); ?> INR</strong></td>
      </tr>
    </table></td>
  </tr> 
  <tr>
