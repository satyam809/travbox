			...
			<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
							<div class="list-icons">
		                		 <a href="display.html?ga=<?php echo $_REQUEST['ga']; ?>&add=1"><button type="button" class="btn btn-primary btn-sm">Add Web Check</button></a>
		                	</div>
	                	</div>
			  </div>		 
...
<tr>
<td align="left" valign="top"><?php if(isset($rest['logo'])){ ?><img src="upload/<?php echo stripslashes($rest['logo']); ?>" width="50" height="50"><?php } ?></td>
