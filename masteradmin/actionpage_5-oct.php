...
$namevalue ='name="'.$name.'",email="'.$email.'",phone="'.$phone.'",address="'.$address.'",branchId="'.$branchId.'",roleId="'.$roleId.'",status="'.$status.'",staffCreditLimit="'.$staffCreditLimit.'",password="'.md5($randPass).'",userType="staff",addDate="'.date('Y-m-d H:i:s').'",addBy="'.$_SESSION['userid'].'",parentId="'.$LoginUserDetails['parentId'].'" '.$sql.'';  
