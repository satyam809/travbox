      ...
      <table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#000000">
          <tr>
			...
			<?php if($editresult['pcc']=="STUDENT" || $editresult['pcc']=="SENIOR_CITIZEN"){ ?>
				<td colspan="2" bgcolor="#E9E9E9"><strong>Document Id</strong></td>
			<?php } ?>
    ...
    //$totalcostings2=mysqli_fetch_array($rs5);
        ...
        ?>
          <tr>
			...
			<?php if($editresult['pcc']=="STUDENT" || $editresult['pcc']=="SENIOR_CITIZEN"){ ?>
			<td colspan="2" style="text-transform:uppercase;"><strong><?php echo $paxData['documentId']; ?></strong></td>
			<?php } ?>
      ...
      <?php } 
        ...
        <table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#000000">
          ...
          ?>
            <tr>
			  ...
			  <?php if($editresult['pcc']=="STUDENT" || $editresult['pcc']=="SENIOR_CITIZEN"){ ?>
			<td colspan="2" style="text-transform:uppercase;"><strong><?php echo $paxData2['documentId']; ?></strong></td>
			<?php } ?> 
			  <td colspan="2" style="text-transform:uppercase;">
       ...
       <table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#000000" style="margin-bottom: 10px;">
           <tr>
             ...
             <td colspan="2" bgcolor="#E9E9E9"><strong>Passenger&nbsp;Name</strong></td>
			 <?php if($editresult['pcc']=="STUDENT" || $editresult['pcc']=="SENIOR_CITIZEN"){ ?>
				<td colspan="2" width="12%" bgcolor="#E9E9E9"><strong>Document Id</strong></td>
				<?php } ?>
  ...
  ?>
    ...
    <table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#CCCCCC">
      ...
      <tr>
	   ...
	   $tex =  number_format(round((($totalcostings['totaltax']/$_REQUEST['tp'])/$_REQUEST['tp'])+($_REQUEST['markup'])));
	}
			  ?>
	  </td>
