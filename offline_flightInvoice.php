...
<table width="100%" border="0" cellpadding="5" style="font-size:12px; ">
  ...
  <tr>
   ...
   $rt2=GetPageRecord('*','flightBookingMaster',' id="'.decode($_REQUEST['id']).'"  order by id asc '); 
    ...
    $rs6=GetPageRecord('*','flightBookingPaxDetailMaster',' BookingId="'.$flightwayret['id'].'" and firstName!="" '); 
      ...
      <tr>
        ...
        echo number_format($bookingdata['baseFare']);
        ...
        echo number_format($bookingdata['tax']);
       ...
       echo number_format($bookingdata['baseFare']+$bookingdata['tax']);
