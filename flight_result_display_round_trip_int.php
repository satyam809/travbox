...
<div>Flight Round International</div>
...
$a=GetPageRecord('*','wig_flight_json_bkp',' agentId="'.$_SESSION['agentUserid'].'" and isRoundTripInt=1  order by AMT asc');
...
<div class="col-4">
 <table border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div class="flightnumber"><?php echo stripslashes($res['FLIGHT_CODE']); ?>-<?php echo stripslashes($res['FLIGHT_NO']); ?>--PCC- <?php echo stripslashes($res['PCC']); ?></div>
...
?>
  ...
  <tr>
    <td align="left" valign="top" style="text-align: center; font-weight: 700; border: 0px;"><span class="mainprice" style="font-size:22px;">&#8377; <?php echo $basefares[1]; ?></span><span class="netpriceshow" style="display:none; color:#009933;font-size:22px;">&#8377; <?php echo $flightprice['netFareBeforecomm']; ?></span>	</td>
    </tr>
  <tr>
