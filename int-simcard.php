...
.landing_bannervisa {
  background-image: url(/images/visa/sim.png);
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-md-5">
                                <div class="section-title mb-10 text-lg-start text-center">
                                    ...
                                    <h3 class="white heading">Get Your International Sim Card With Our <br/>Quick and Easy Process</h3><br>
                                    <div class="container">
  <div class="row">
    <div class="col text-center">
      <a href="#visa"><button class="btn btn-sm"  style="background-color:#0d4980; color:white; font-weight:500; font-size:30px;border-radius: 15px; padding: 5px 15px;">Get Your International Sim Card!</button></a>
    </div>
  </div>
</div>
                                </div>
          ...
          <div class="col-md-4 my-2">
                <div class="px-3 my-5">
                    ...
                    <div class="px-3 text-center pb-3">
                        ...
                        <p class="text-muted my-3" style="font-size: 15px;">With your approved Simcard in hand, you're ready to explore the world.</p>
                    </div>
                </div>
            </div>
          <div class="col-md-4 my-2">
                <div class="px-3 my-5">
                    <div class="circle text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-4"
                         style="width: 60px;height: 60px;">
                        <img src="/images/visa/phone.png"/ style="height: 75px;">
                    </div>
                    <div class="px-3 text-center pb-3">
                        <h5 style="font-weight: 600 ; color:#0d4980; font-size: 23px;">Get Your Sim Card</h5>
                        <p class="text-muted my-3" style="font-size: 15px;">Download your approved Sim Card, and you're ready to go!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row firstrow">
            <!--<div class="col-lg-12 d-flex" style="border-bottom:1px solid var(--lightgray)">-->
              <div class="col-lg-12 d-flex" >  
                <div>
                    <h1 class="pt-3 ms-4 me-4 my-2 pb-3 createheading"> International Sim Care Form</h1>
