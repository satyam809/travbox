...
$systemname="Htravbox Technologies";

$footerversion="@ copyright ".date('Y')." - $systemname"; 
...
$fullurl1 = "http://localhost/travbox/login";
...
$imgurl="https://ofc.travbox.travel/upload/";
...
$landingpagedatas='http://localhost/travbox/landingpagedata/';

$superadminupload='https://travbox.travel/upload/';
