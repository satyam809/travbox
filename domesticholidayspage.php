...
<title>Domestic Holidays - <?php echo stripslashes($getcompanybasicinfo['companyName']); ?></title>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="holidaysearch">
                    ...
                    <i class="fa fa-suitcase" aria-hidden="true"></i> Domestic Holiday Tour Packages</h1>

                    <form  method="GET" id="formids" action="domestic-holidays-search" > 
...
<section class="holidaydestination"> 
	...
	<div class="container holicontainer">
     ...
     $bb=GetPageRecord('*','quotationMaster','  destination in (select id from cityMaster where stateId in(select id from stateMaster where countryId in (select id from countryMaster where name="India"))) and bannerImg!="" '.$where.' and categoryId=0 and status=1  order by rand() asc   '); 
