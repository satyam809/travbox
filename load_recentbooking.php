            ...
            <?php if ($totalbookings['totalcountbooking'] > 0) { ?>
                ...
                <table border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC" class="table" style="margin-bottom:0px;">
                    ...
                    <tbody>
                        ...
                        $page = isset($_GET['records']) ? clean($_GET['page']) : '';
                        $sNo = 1;
                        ...
                        ?>
                            ...
                            <tr onClick="loadpop('View Ticket',this,'900px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=viewTicket&id=<?php echo encode($rest['id']); ?>">
                                ...
                                <td align="left" valign="middle">
                                    ...
                                    <span style="font-size:11px;"><?php echo date('d-m-Y h:i A', strtotime($rest['bookingDate'])); ?></span>
                                </td>

                                <td align="left" valign="middle"><span style="color:#000;"><i class="fa fa-plane" aria-hidden="true"></i>
                                ...
                                <td align="center" valign="middle" style="font-size:14px;">
                                    <div align="center">&#8377;<?php
                                                                ...
                                                                echo number_format(
                                                                    (float)$totalcostings['totalagentTotalFare']
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr onClick="loadpop('View Hotel Voucher',this,'900px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=viewHotelVoucher&id=<?php echo  encode($rest['id']); ?>&page=<?php echo $_REQUEST['ga']; ?>">
                                ...
                                <td align="left" valign="middle">
                                    <strong>Ref.:</strong> <?php echo encode($rest['id']); ?><br>
                                    <span style="font-size:11px;"><?php echo date('d-m-Y h:i A', strtotime($rest['addDate'])); ?></span>
                                </td>
                                ...
                                <td align="left" valign="middle">
                                    <div style="width:150px; font-size:11px;"><?php echo stripslashes($rest['RoomType']); ?></div>
                                </td>
                                <td align="left" valign="middle"><strong>Room: </strong><?php echo  stripslashes($totalbookungpax_room['roomNo']); ?><br />
                                    ...
                                    <strong>Child: </strong><?php echo  stripslashes($totalbookungpax_child['totalchild']); ?>
                                </td>
                                ...
                                <td align="center" valign="middle" style="font-size:14px;">
                                    <div align="center">&#8377;<?php echo round($rest['agentTotalFare']); ?> </div>
                                </td>
                            </tr>
                        <?php $sNo++;
                        } ?>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="middle"><span style="color:#000;"><?php echo strip($rest['hotelName']); ?> <br />
                                        ...
                                        <div style="width:140px;"><?php echo date('d-m-Y h:i A', strtotime($rest['addDate'])); ?></div>
                                </td>

                                <td align="left" valign="middle"><?php echo strip($rest['roomName']); ?><br />

                                    <strong>Rooms:</strong> <?php echo strip($rest['room']); ?> | <strong>Adult:</strong> <?php echo strip($rest['room']); ?> | <strong>Child:</strong> <?php echo strip($rest['child']); ?>
                                </td>

                                <td align="left" valign="middle">
                                    <div style="width:130px;"><strong>Checkin: </strong><?php echo date('d-m-Y', strtotime($rest['startDate'])); ?><br />

                                        <strong>Checkout: </strong><?php echo date('d-m-Y', strtotime($rest['endDate'])); ?>
                                    </div>
                                </td>
                                <td align="left" valign="middle"><?php echo strip($rest['name']); ?><br />
                                    ...
                                    <strong>Email:</strong> <?php echo strip($rest['email']); ?>
                                </td>
                ...
                <table border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC" class="table" style="margin-bottom:0px;">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                <td align="left" valign="top"><strong><?php echo strip($rest['packageName']); ?></strong>
                                    <div style="width:140px;"><?php echo date('d-m-Y h:i A', strtotime($rest['addDate'])); ?></div>
                                </td>
